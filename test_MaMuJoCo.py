...
k_dicts_tasks = [
    ...
    pre_computed_k_dict("HalfCheetah", "6x1", ["[{0: [bfoot]}, {0: [bshin]}, {0: [bthigh]}, {0: [ffoot]}, {0: [fshin]}, {0: [fthigh]}]", "[{0: [bfoot], 1: [bshin]}, {0: [bshin], 1: [bfoot, bthigh]}, {0: [bthigh], 1: [bshin, fthigh]}, {0: [ffoot], 1: [fshin]}, {0: [fshin], 1: [ffoot, fthigh]}, {0: [fthigh], 1: [bthigh, fshin]}]", "[{0: [bfoot], 1: [bshin], 2: [bthigh]}, {0: [bshin], 1: [bfoot, bthigh], 2: [fthigh]}, {0: [bthigh], 1: [bshin, fthigh], 2: [bfoot, fshin]}, {0: [ffoot], 1: [fshin], 2: [fthigh]}, {0: [fshin], 1: [ffoot, fthigh], 2: [bthigh]}, {0: [fthigh], 1: [bthigh, fshin], 2: [bshin, ffoot]}]"]),  # noqa: E501
    ...
    pre_computed_k_dict("manyagent_swimmer", "10x2", ["[{0: [rot0, rot1]}, {0: [rot2, rot3]}, {0: [rot4, rot5]}, {0: [rot6, rot7]}, {0: [rot8, rot9]}, {0: [rot10, rot11]}, {0: [rot12, rot13]}, {0: [rot14, rot15]}, {0: [rot16, rot17]}, {0: [rot18, rot19]}]", "[{0: [rot0, rot1], 1: [rot2]}, {0: [rot2, rot3], 1: [rot1, rot4]}, {0: [rot4, rot5], 1: [rot3, rot6]}, {0: [rot6, rot7], 1: [rot5, rot8]}, {0: [rot8, rot9], 1: [rot10, rot7]}, {0: [rot10, rot11], 1: [rot12, rot9]}, {0: [rot12, rot13], 1: [rot11, rot14]}, {0: [rot14, rot15], 1: [rot13, rot16]}, {0: [rot16, rot17], 1: [rot15, rot18]}, {0: [rot18, rot19], 1: [rot17]}]", "[{0: [rot0, rot1], 1: [rot2], 2: [rot3]}, {0: [rot2, rot3], 1: [rot1, rot4], 2: [rot0, rot5]}, {0: [rot4, rot5], 1: [rot3, rot6], 2: [rot2, rot7]}, {0: [rot6, rot7], 1: [rot5, rot8], 2: [rot4, rot9]}, {0: [rot8, rot9], 1: [rot10, rot7], 2: [rot11, rot6]}, {0: [rot10, rot11], 1: [rot12, rot9], 2: [rot13, rot8]}, {0: [rot12, rot13], 1: [rot11, rot14], 2: [rot10, rot15]}, {0: [rot14, rot15], 1: [rot13, rot16], 2: [rot12, rot17]}, {0: [rot16, rot17], 1: [rot15, rot18], 2: [rot14, rot19]}, {0: [rot18, rot19], 1: [rot17], 2: [rot16]}]"]),  # noqa: E501
    pre_computed_k_dict("manyagent_swimmer", "6x1", ["[{0: [rot0]}, {0: [rot1]}, {0: [rot2]}, {0: [rot3]}, {0: [rot4]}, {0: [rot5]}]", "[{0: [rot0], 1: [rot1]}, {0: [rot1], 1: [rot0, rot2]}, {0: [rot2], 1: [rot1, rot3]}, {0: [rot3], 1: [rot2, rot4]}, {0: [rot4], 1: [rot3, rot5]}, {0: [rot5], 1: [rot4]}]", "[{0: [rot0], 1: [rot1], 2: [rot2]}, {0: [rot1], 1: [rot0, rot2], 2: [rot3]}, {0: [rot2], 1: [rot1, rot3], 2: [rot0, rot4]}, {0: [rot3], 1: [rot2, rot4], 2: [rot1, rot5]}, {0: [rot4], 1: [rot3, rot5], 2: [rot2]}, {0: [rot5], 1: [rot4], 2: [rot3]}]"]),  # noqa: E501
    pre_computed_k_dict("manyagent_ant", "2x3", ["[{0: [ankle1_0, ankle1_1, ankle1_2, ankle2_0, ankle2_1, ankle2_2, hip1_0, hip1_1, hip1_2, hip2_0, hip2_1, hip2_2]}, {0: [ankle1_3, ankle1_4, ankle1_5, ankle2_3, ankle2_4, ankle2_5, hip1_3, hip1_4, hip1_5, hip2_3, hip2_4, hip2_5]}]", "[{0: [ankle1_0, ankle1_1, ankle1_2, ankle2_0, ankle2_1, ankle2_2, hip1_0, hip1_1, hip1_2, hip2_0, hip2_1, hip2_2], 1: [hip1_0, hip1_1, hip2_0, hip2_1]}, {0: [ankle1_3, ankle1_4, ankle1_5, ankle2_3, ankle2_4, ankle2_5, hip1_3, hip1_4, hip1_5, hip2_3, hip2_4, hip2_5], 1: [hip1_2, hip1_3, hip1_4, hip2_2, hip2_3, hip2_4]}]", "[{0: [ankle1_0, ankle1_1, ankle1_2, ankle2_0, ankle2_1, ankle2_2, hip1_0, hip1_1, hip1_2, hip2_0, hip2_1, hip2_2], 1: [hip1_0, hip1_1, hip2_0, hip2_1], 2: []}, {0: [ankle1_3, ankle1_4, ankle1_5, ankle2_3, ankle2_4, ankle2_5, hip1_3, hip1_4, hip1_5, hip2_3, hip2_4, hip2_5], 1: [hip1_2, hip1_3, hip1_4, hip2_2, hip2_3, hip2_4], 2: []}]"]),  # noqa: E501
    pre_computed_k_dict("manyagent_ant", "3x1", ["[{0: [ankle1_0, ankle2_0, hip1_0, hip2_0]}, {0: [ankle1_1, ankle2_1, hip1_1, hip2_1]}, {0: [ankle1_2, ankle2_2, hip1_2, hip2_2]}]", "[{0: [ankle1_0, ankle2_0, hip1_0, hip2_0], 1: []}, {0: [ankle1_1, ankle2_1, hip1_1, hip2_1], 1: [hip1_0, hip2_0]}, {0: [ankle1_2, ankle2_2, hip1_2, hip2_2], 1: [hip1_1, hip2_1]}]", "[{0: [ankle1_0, ankle2_0, hip1_0, hip2_0], 1: [], 2: []}, {0: [ankle1_1, ankle2_1, hip1_1, hip2_1], 1: [hip1_0, hip2_0], 2: []}, {0: [ankle1_2, ankle2_2, hip1_2, hip2_2], 1: [hip1_1, hip2_1], 2: []}]"]),  # noqa: E501
    pre_computed_k_dict("coupled_half_cheetah", "1p1", ["[{0: [bfoot0, bshin0, bthigh0, ffoot0, fshin0, fthigh0]}, {0: [bfoot1, bshin1, bthigh1, ffoot1, fshin1, fthigh1]}]", "[{0: [bfoot0, bshin0, bthigh0, ffoot0, fshin0, fthigh0], 1: []}, {0: [bfoot1, bshin1, bthigh1, ffoot1, fshin1, fthigh1], 1: []}]", "[{0: [bfoot0, bshin0, bthigh0, ffoot0, fshin0, fthigh0], 1: [], 2: []}, {0: [bfoot1, bshin1, bthigh1, ffoot1, fshin1, fthigh1], 1: [], 2: []}]"]),
]
# fmt: on
