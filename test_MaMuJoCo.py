...
if __name__ == "__main__":
    ...
    for ok in [None, 0, 1]:
        ...
        agent_conf = None
        parallel_api_test(
            MaMuJoCo(scenario=scenario, agent_conf=agent_conf, agent_obsk=ok),
    ...
    assert (
        str(test_env.k_dicts)
        == "[{0: [rot0, rot1], 1: [rot2], 2: [rot3]}, {0: [rot2, rot3], 1: [rot1, rot4], 2: [rot0, rot5]}, {0: [rot4, rot5], 1: [rot3, rot6], 2: [rot2, rot7]}, {0: [rot6, rot7], 1: [rot5, rot8], 2: [rot4, rot9]}, {0: [rot8, rot9], 1: [rot10, rot7], 2: [rot11, rot6]}, {0: [rot10, rot11], 1: [rot12, rot9], 2: [rot13, rot8]}, {0: [rot12, rot13], 1: [rot11, rot14], 2: [rot10, rot15]}, {0: [rot14, rot15], 1: [rot13, rot16], 2: [rot12, rot17]}, {0: [rot16, rot17], 1: [rot15, rot18], 2: [rot14, rot19]}, {0: [rot18, rot19], 1: [rot17], 2: [rot16]}]"
    ), "wrong k_dicts: " + str(test_env.k_dicts)
    agent_conf = "6x1"
    test_env = MaMuJoCo(scenario=scenario, agent_conf=agent_conf, agent_obsk=0)
    assert (
